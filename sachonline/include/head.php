...
<!-- Navbar (sit on top) -->
<div class="w3-top">
  <div class="w3-bar w3-wide w3-padding w3-card top_header">
    <a href="#home" class="w3-bar-item w3-button" style="text-decoration: none"><b>BOOK</b>store</a>

<div class="input-group input_group_css">
