   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
               <li>
                  <i class="fa fa-dashboard"></i>  <a href="">Quản lí sách kĩ thuật</a>
               </li>
            </ol>
            <table class="table">
               <tr style="color: red;">
               ...
               <?php
                  ...
                  $sql = "SELECT * FROM book, type_book where type_book.book_type=book.book_type and type_book.book_type ='KT' limit $trang1,8";	
