   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
               <li>
                  <i class="fa fa-dashboard"></i>  <a href="">Quản lí sách tiếng anh</a>
               </li>
            </ol>
            <table class="table">
               <tr style="color: red;">
               ...
               <?php
                  ...
                  $sql = "SELECT * FROM book, type, punisher where type.book_type=book.book_type and type.book_type ='TA'and punisher.punisher_id = book.punisher_id limit $trang1,8";	
